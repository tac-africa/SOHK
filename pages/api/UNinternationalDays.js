...
export const data = [
    {
        ...
        events: [
            {
                ...
                date: 27,
                event: ["International Day of Commemoration in Memory of the Victims of the Holocaust"]
            },
        ]   
    },
        {
        ...
        events: [
            {
                date: 4,
                event: ["International Day of Human Fraternity"]
            },
            {
                date: 6,
                event: ["International Day of Zero Tolerance for Female Genital Mutilation"]
            },
            {
                date: 10,
        ...
        events: [
            ...
            {
                date: 10,
                event: ["International Day of Women Judges"]
            },
            {
                date: 20,
                event: ["French Language Day", "Day of Happiness"]
            },
            {
                date: 21,
                event: [
        ...
        events: [
            ...
            {
                date: 4,
                event: ["United Nations' Mine Awareness Day"]
            },
            {
                date: 5,
            ...
            {
                date: 24,
                event: ["International Day of Multilateralism and Diplomacy for Peace"]
            },
             {
                date: 25,
                event: [
        ...
        events: [
            ...
            {
                date: 5,
                event: ["World Portuguese Language Day"]
            },
                 {
                date: 8,
                event: ["Time of Remembrance and Reconciliation for Those Who Lost Their Lives during the Second World War"]
            },
            {
                date: 10,
                event: ["International Day of Argania"]
            },
                 {
                date: 14,
            ...
            {
                date: 29,
                event: ["International Day of United Nations Peacekeepers"]
            },
            {
                date: 31,
        ...
        events: [
            ...
            {
                date: 6,
                event: ["Day of the Russian Language"]
            },
            {
                date: 7,
            ...
            },
            {
             ...
             {
                date: 19,
                event: ["International Day for the Elimination of Sexual Violence in Conflict"]
            },
             {
                date: 20,
            ...
            },
            {
             ...
             {
                date: 27,
                event: ["Micro-, Small and Medium-sized Enterprises Day"]
            },
             {
                date: 29,
                event: ["International Day of the Tropics"]
            },
            {
                date: 30,
                event: [
        ...
        events: [
            {
                date: 2,
                event: ["International Day of Cooperatives"]
            },
            {
                date: 11,
        ...
        events: [
            {
                date: 9,
                event: ["International Day of the World's Indigenous People"]
            },
            {
                date: 12,
            ...
            {
                date: 21,
                event: ["International Day of Remembrance of and Tribute to the Victims of Terrorism"]
            },
            {
                date: 22,
                event: ["International Day Commemorating the Victims of Acts of Violence Based on Religion or Belief"]
            },
            {
                date: 23,
                event: ["International Day for the Remembrance of the Slave Trade and its Abolition"]
            },
            {
                date: 29,
            ...
            {
                date: 31,
                event: ["International Day for People of African Descent"]
            },
        ]   
    },    {
        month: "September",
        events: [
            ...
            },
            {
             ...
             {
                date: 9,
                event: ["International Day to Protect Education from Attack"]
            },
            {
                date: 12,
                event: ["International Day for South-South Cooperation"]
            },
            {
                date: 15,
            ...
            {
                date: 28,
                event: ["International Day for Universal Access to Information"]
            },
             {
                date: 29,
        ...
        events: [
            {
             ...
             {
                date: 5,
                event: ["World Tsunami Awareness Day"]
            },
            {
                date: 6,
                event: ["International Day for Preventing the Exploitation of the Environment in War and Armed Conflict"]
            },
               {
                date: 10,
        ...
        events: [
            ...
            {
                date: 4,
                event: ["International Day of Banks"]
            },
            {
                date: 5,
                event: [
            ...
            {
                date: 27,
                event: ["International Day of Epidemic Preparedness"]
            },
        ]   
    }
]
